...
%% API
-export([main/1,
         add_schema/2, add_schema/3,
         del_schema/1,
         load_schemas/2, load_schemas/3,
         validate/2, validate/3,
         validate_with_schema/2, validate_with_schema/3]).
...
-spec load_schemas(Path :: string(),
                   ParserFun :: fun((binary()) -> json_term())) -> jesse_database:store_result().
...
-spec load_schemas(Path :: string(),
                   ...
                   ValidationFun :: validation_fun()) -> jesse_database:store_result().
...
-spec validate(Schema :: schema() | binary(),
               Data :: json_term() | binary()) -> {ok, json_term()} |
                                                  jesse_error:error() |
